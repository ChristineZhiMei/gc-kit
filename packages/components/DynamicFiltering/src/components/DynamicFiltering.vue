...
import type { FilterItemType, FilterItemsKeyMapType, FilterValue, showFilterItemType } from "@/types/DynamicFiltering"
import {Filter, RefreshRight} from "@element-plus/icons-vue";
import PredefineFiltering from "@/components/DynamicFiltering/PredefineFiltering.vue";
import {pinyin} from "pinyin-pro";
const router = useRouter()
const route = useRoute()
const emit = defineEmits(['change', 'applyFiltering', 'applyNonFiltering'])
